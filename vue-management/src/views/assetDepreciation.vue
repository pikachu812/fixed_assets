...
<!--        <el-button type="warning" :icon="CirclePlusFilled" @click="visible = true">新增</el-button>-->
      ...
      >
        ...
        <el-table-column prop="assetName" label="资产名称" align="center" width="120%"></el-table-column>
        <el-table-column prop="employeeName" label="员工姓名" align="center" width="120%"></el-table-column>
        <el-table-column prop="departmentName" label="部门名称" align="center" width="120%"></el-table-column>
